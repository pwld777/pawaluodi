...
- `hand-drum-strong.wav`: `samples/Darbuka/doom_01_01.wav`, used as a low center hit for the flower-drum challenge.
- `hand-drum-rim.wav`: `samples/Darbuka/tak_02_01.wav`, used as a brighter edge hit for the flower-drum challenge.
